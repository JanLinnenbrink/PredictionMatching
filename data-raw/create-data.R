## code to prepare the dataset used in the example
...
# --- generate and save the raster stack -----------------------------------
set.seed(100)

raster_stack <- generate_rast()
...
train_points <- simsam::sam_field(
  raster_stack$elev * -1,
  100,
  method = simsam::sample_preferential(strength = 5)
)
